  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-4xl mx-auto py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
        {showSuccessBanner && (
          <div className="mb-6 sm:mb-8 bg-green-100 dark:bg-green-900 border border-green-400 dark:border-green-600 text-green-800 dark:text-green-200 px-4 py-3 rounded-lg transition-colors duration-300" role="alert">
                        ...
                        {showJson ? (
                          <>
                            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L8.464 8.464M15.536 15.536L16.95 16.95" />
                            </svg>
                            {t('home.hideJson')}
                          </>
                        ) : (
          ...
          {showJson && user && (
            <div className="grid md:grid-cols-2 gap-6 mt-12 animate-fade-in">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all duration-300 opacity-0 animate-slide-in-left">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2 transition-colors duration-300">{t('home.userDataTitle')}</h3>
                <pre className="text-gray-600 dark:text-gray-300 transition-colors duration-300 text-sm bg-gray-50 dark:bg-gray-700 p-4 rounded-md overflow-x-auto">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all duration-300 opacity-0 animate-slide-in-right">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">{t('home.accountInfoTitle')}</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-600">
                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400">{t('home.nameLabel')}</span>
                    <span className="text-sm text-gray-900 dark:text-white">{user.nombre}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-600">
                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400">{t('home.emailLabel')}</span>
                    <span className="text-sm text-gray-900 dark:text-white">{user.email}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-600">
                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400">{t('home.statusLabel')}</span>
                    <span className="text-sm text-green-600 dark:text-green-400 font-medium">{t('home.statusActive')}</span>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400">{t('home.registrationDateLabel')}</span>
