...
const translations = {
  es: {
    ...
    "validation.confirmNewPasswordRequired":
      "Confirmar nueva contraseña es obligatorio",
    "validation.currentPasswordIncorrect": "La contraseña actual es incorrecta",
    "validation.newPasswordMustBeDifferent":
    ...
    "notifications.logoutSuccessMessage":
      "Hasta luego, {{name}}. Tu sesión ha sido cerrada correctamente.",
    "notifications.passwordChangeSuccess": "Contraseña cambiada",
    "notifications.passwordChangeSuccessMessage":
      "Tu contraseña ha sido actualizada correctamente.",
    "notifications.passwordChangeError":
    ...
    "home.accountCreatedSuccess":
      "Tu cuenta ha sido creada exitosamente. Puedes ver tus datos haciendo clic en el botón de abajo.",
    "home.startRegistration": "Comienza tu registro",
    "home.joinDescription":
      "Únete a Humano Seguros y descubre nuestros servicios de protección integral.",
    ...
    "userCard.noUserMessage":
      "Por favor, regístrate o inicia sesión para ver tus datos.",
    ...
    "modal.changePassword.currentPasswordPlaceholder":
      "Ingresa tu contraseña actual",
    "modal.changePassword.newPassword": "Nueva Contraseña",
    "modal.changePassword.newPasswordPlaceholder":
      "Ingresa tu nueva contraseña",
    "modal.changePassword.confirmNewPassword": "Confirmar Nueva Contraseña",
    "modal.changePassword.confirmNewPasswordPlaceholder":
  ...
  en: {
    ...
    "validation.passwordMaxLength":
      "Password cannot be more than 50 characters",
    ...
    "notifications.logoutSuccessMessage":
      "See you later, {{name}}. Your session has been closed successfully.",
    ...
    "home.accountCreatedSuccess":
      "Your account has been created successfully. You can view your data by clicking the button below.",
    "home.startRegistration": "Start your registration",
    "home.joinDescription":
      "Join Humano Insurance and discover our comprehensive protection services.",
