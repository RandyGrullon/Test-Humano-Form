...
export default function Navbar() {
    ...
    const handleLogout = () => {
        ...
        setTimeout(() => {
            ...
            toast.success(t('notifications.logoutSuccessMessage', { name: userName }), {
                duration: 4000,
            });
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center">
                        <Link href="/" className="text-lg sm:text-xl font-bold hover:text-gray-200 dark:hover:text-gray-300 transition-colors">
                            {t('navbar.brand')}
                        </Link>
                    </div>
